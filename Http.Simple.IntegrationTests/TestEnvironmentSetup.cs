...
namespace Http.Simple.IntegrationTests
{
    ...
    public class TestEnvironmentSetup
    {
        ...
        private const string EntityPathRequiringClientCertificate = "ovc-cicd-relay-echo-cert";
        ...
        private const string ClientCertificateThumbprint = "88621C7F1DDF3E897BFCB7FF7F5EA888AF6F1A73";
        ...
        public async Task Cleanup()
        {
            ...
            await StopServiceRequiringClientCertificate();
